jQuery(document).ready(function ($) {
	...
	$(function () {
		...
		$(".dr-scale-ingredients").bind("keyup mouseup", function () {
		...
		$("#dr-vdo-toggle").change(function (e) {
			if ($(this).is(":checked")) {
	...
	$(".post-share a.meta-title").click(function (e) {
		e.stopPropagation();
		$(this).siblings(".social-networks").slideToggle();
	});

	$(".post-share").click(function (e) {
		e.stopPropagation();
	});
	...
	$("#dr-recipes-clear-filters").click(function (e) {
		e.preventDefault();
