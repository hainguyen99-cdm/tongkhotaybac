...
$global_toggles = delicious_recipes_get_global_toggles_and_labels();
    ...
    if( $global_toggles['enable_poweredby'] ) : ?>
        ...
        <div class="dr-poweredby">
            ...
            <a href="https://wpdelicious.com/" target="_blank" rel="nofollow noopener noreferrer" ><img src="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>/assets/images/Delicious-Recipes.png" alt="Delicious Recipes"></a>
        </div>
