        ...
        <header class="dr-header">
            <div class="dr-left-block">
                <h1 class="dr-plugin-title">
                    <img src="<?php echo plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ?>/assets/images/plugin-logo.png" alt="import recipes">
                </h1>
                                ...
                                <div class="dr-block-content">
                                    <?php
                                        if ( ! $importer->is_plugin_active() ) {
                                            ...
                                            echo '<h4>' . sprintf( esc_html__( '%1$s plugin is not installed or activated. Please activate the %2$s plugin first to start import.', 'delicious-recipes' ), $importer->get_name(), $importer->get_name() ) . '</h4>';
                                        } else {
                                            ...
                                            if ( 0 === count( $recipes_to_import ) ) :
                                                /* translators: %1$s: importer plugin name %2$s: importer plugin name*/
                                                echo '<h4>' . sprintf( esc_html__( 'All the recipes from %1$s plugin has been imported. You can now deactivate the %2$s plugin.', 'delicious-recipes' ), $importer->get_name(), $importer->get_name() ) . '</h4>';
                                            else :
