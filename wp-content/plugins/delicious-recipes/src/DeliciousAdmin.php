...
class DeliciousAdmin {
	...
	private function add_image_sizes() {
		...
		// add_image_size( 'category-thumb-small', 72, 45, true ); // 72 pixels wide by 45 pixels tall, hard crop mode
		add_image_size( 'recipe-feat-thumbnail', 124, 166, true ); // 124 pixels wide by 166 pixels tall, hard crop mode
		// add_image_size( 'recipe-feat-square', 240, 240, true ); // 240 pixels wide by 240 pixels tall, hard crop mode
		add_image_size( 'recipe-feat-tall', 290, 386, true ); // 290 pixels wide by 386 pixels tall, hard crop mode
		// add_image_size( 'recipe-feat-full', 687, 387, true ); // 687 pixels wide by 387 pixels tall, hard crop mode
	...
	public function add_nav_menu_meta_boxes() {
		add_meta_box( 'dr_surprise_me_nav_link', __( 'Delicious Recipes', 'woocommerce' ), array( $this, 'nav_menu_links' ), 'nav-menus', 'side', 'low' );
	}
		...
		<div id="posttype-delicious-recipes" class="posttypediv">
				...
				<ul id="delicious-recipes-checklist" class="categorychecklist form-no-clear">
					<li>
						<label class="menu-item-title">
							<input type="checkbox" class="menu-item-checkbox" name="menu-item[<?php echo (int) $_nav_menu_placeholder; ?>][menu-item-object-id]" value="-1"> <?php esc_html_e( 'Surprise Me', 'polylang' ); ?>
						</label>
						...
						<p id="menu-item-name-wrap" class="wp-clearfix">
							<label class="regular-text menu-item-textbox" for="custom-menu-item-name<?php echo (int) $_nav_menu_placeholder; ?>"><?php esc_html_e( 'Link Text' ) ?></label>
			...
			<p class="button-controls">
				<span class="add-to-menu">
					<input type="submit" <?php disabled( $nav_menu_selected_id, 0 ); ?> class="button-secondary submit-add-to-menu right" value="<?php esc_attr_e( 'Add to Menu', 'polylang' ); ?>" name="add-custom-menu-item" id="submit-posttype-delicious-recipes">
	...
	public function enqueue_scripts() {
		...
		$data = array(
			...
			'title'   => __( 'Surprise Me', 'polylang' ), // The title
			'val'     => array(),
		);
