...
class Delicious_Recipes_Template_Hooks {
    ...
    private function init_single_recipe_hooks() {
        ...
        add_action( 'delicious_recipes_equipments', array( $this, 'recipe_main_equipments' ) );
        ...
        add_action( 'delicious_recipes_single_after_content_end', array( $this, 'recipe_author_sign' ), 20 );
    ...
    public function recipe_main_equipments() {
        delicious_recipes_get_template( 'recipe/recipe-block/equipments.php' );
    }
    ...
    /**
     * Get Recipe page author sign template.
     *
     * @return void
     */
    public function recipe_author_sign() {
        delicious_recipes_get_template( 'recipe/author-sign.php' );
    }
