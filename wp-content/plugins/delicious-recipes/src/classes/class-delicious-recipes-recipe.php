...
class Delicious_Recipes_Recipe {
	...
	public function get_recipe( $recipe_id = false, $deprecated = array() ) {
		...
		$recipe_data = array(
			...
			'thumbnail'            => has_post_thumbnail( $recipe_id ) ? get_the_post_thumbnail_url( $recipe_id, 'recipe-archive-grid' ) : '',
	...
	private function get_difficulty_level( $recipe_id ) {
	    ...
	    $difficulty_level = $difficulty_level ? $levels[$difficulty_level] : $difficulty_level;
	...
	private function get_total_time( $recipe_id ) {
		...
		$preptime_unit = $this->get_preparation_time_unit( $recipe_id );
		$cooktime_unit = $this->get_cook_time_unit( $recipe_id );
		$resttime_unit = $this->get_rest_time_unit( $recipe_id );
