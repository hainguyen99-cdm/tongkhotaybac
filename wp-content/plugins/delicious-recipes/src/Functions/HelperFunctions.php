 ...
 * @return void
 */
function delicious_recipes_search_taxonomy_render( $taxonomy_array, $has_children = false, $name ) {
...
function get_surprise_me_options( $type = 'widget', $key = 'string' ) {
    $options = array(
        'show_icon'      => array( 'string' => __( 'Displays icon', 'polylang' ), 'default' => 1 ),
        'show_text'      => array( 'string' => __( 'Displays text', 'polylang' ), 'default' => 1 ),
        'show_text_icon' => array( 'string' => __( 'Displays text & icon', 'polylang' ), 'default' => 1 ),
        'show_posts'     => array( 'string' => __( 'Randomize posts', 'polylang' ), 'default' => 0 ),
    );
